  ...
  <div>
    ...
    <article className="cf ph2-ns w-100 flex items-center bg-gradient">
      <div className="w-80-ns tc center ">
        ...
        <span className="b primary-color">Data scores that combine data from a variety of both online and offline activities are becoming a way to categorize citizens, allocating services, and predicting future behavior.</span> Yet little is still known about the implementation of data-driven systems and algorithmic processes in public services and how citizens are increasingly ‘scored’ based on the collection and combination of data.
        </p>
        <p className=" near-black ">
          As part of our project{" "}
          <span className="primary-color">‘Data Scores as Governance’</span> we have developed a tool to map and investigate the uses of data analytics and algorithms in public services in the UK. This tool is designed to facilitate further research and investigation into this topic and to advance public knowledge and understanding.
        </p>

        <p className=" near-black pb4 mb4">
        The tool is made up of a collection of documents from different sources that can be searched and mapped according to different categories. The database consists of almost XXXXX <span className="b"> unverified documents</span> that have been scraped based on a number of search terms relating to data systems in government. This is an incomplete and on-going data-set. You can read more in our <Link className="link primary-color" to="/insights">Methodology section</Link>.
        </p>
      </div>
    </article>
    ...
    <section className="flex flex-column items-center">
      ...
      This project is carried out by the Data Justice Lab.  The Data Justice Lab examines the intricate relationship between datafication and social justice, highlighting the politics and impacts of data-driven processes and big data. The lab is hosted at Cardiff University’s School of Journalism, Media and Culture. Read more here: <Link className="tc center link primary-color" to="https://datajusticelab.org/">datajusticelab.org </Link>.</p>
      <p className="w-60-ns tc center f5 flex flex-wrap pb5">Team: Lina Dencik, Arne Hintz, Joanna Redden, Harry Warne, Christo Buschek, Olivia Solis</p>
